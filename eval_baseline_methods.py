...
def main(args):
    traffic_reading_df = pd.read_csv(args.traffic_reading_filename, index_col=0)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--traffic_reading_filename', default="data/urban_core_speed.csv", type=str,
